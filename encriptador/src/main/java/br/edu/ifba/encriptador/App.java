package br.edu.ifba.encriptador;
...
public class App {
        ...
        private static final String VIDEO =
                "src/main/resources/video/RecifeDeCoralComPeixes.mp4";

        private static final String ALGORITMO =
                "RSA";

        private static final String CHAVE_PUBLICA =
                "../cliente/chaves/ch_publica.chv";

        private static final String CHAVE_PRIVADA =
                "../servidor/chaves/ch_privada.chv";

        public static void main(String[] args)
                throws Exception {

                GeradorDeAleatoriedadeReal aleatoriedade =
                        new GeradorDeAleatoriedadeReal(
                                VIDEO
                        );

                GeradorDeChaves<GeradorDeAleatoriedadeReal>
                        gerador =
                        new GeradorDeChavesImpl();
